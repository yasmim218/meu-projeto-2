function getProjects() {
    const urlGitHub = "https://api.github.com/users/yasmim218/repos"; // Inserir o nome de usuário do seu github
  ...
  function showProjects(data) {
    ...
    data.forEach((repo) => {
      ...
      a.href = repo["hhttps://github.com/yasmim218?tab=repositories"]; // Link para o repositório no GitHub
      a.target = "_blank";
